...
from eval import retrieve_qm9_smiles, analyze_stability_for_molecules, retrieve_geom_smiles, compute_qm9_smiles
...
if __name__ == '__main__':
    ...
    if args.dataset=='qm9':
        ...
        ckpt['model'] = remove_module_prefix(ckpt['model'])
        model.load_state_dict(ckpt['model'])
