...
bonds1 = {
    'H': {'H': 74, 'Li': 155, 'C': 109, 'N': 101, 'O': 96, 'F': 92,
          'B': 119, 'Si': 148, 'P': 144, 'As': 152, 'S': 134,
          'Cl': 127, 'Br': 141, 'I': 161},
    'Li': {'Li': 134, 'H': 155, 'C': 182, 'N': 166, 'O': 148,
           'F': 142, 'Si': 262, 'P': 251, 'S': 243, 'Cl': 238,
           'Br': 267, 'I': 296},
    'C': {'H': 109, 'Li': 182, 'C': 154, 'N': 147, 'O': 143, 'F': 135,
          'Si': 185, 'P': 184, 'S': 182, 'Cl': 177, 'Br': 194,
          'I': 214},
    'N': {'H': 101, 'Li': 166, 'C': 147, 'N': 145, 'O': 140, 'F': 136,
          'Cl': 175, 'Br': 214, 'S': 168, 'I': 222, 'P': 177},
    'O': {'H': 96, 'Li': 148, 'C': 143, 'N': 140, 'O': 148, 'F': 142,
          'Br': 172, 'S': 151, 'P': 163, 'Si': 163, 'Cl': 164,
          'I': 194},
    'F': {'H': 92, 'Li': 142, 'C': 135, 'N': 136, 'O': 142, 'F': 142,
...
def build_xae_molecule(positions, atom_types, dataset_info):
    ...
    for i in range(n):
        for j in range(i):
            ...
            elif dataset_info['name'] == 'geom' or dataset_info['name'] == 'crossdock' or dataset_info['name'] == 'the_main_dataset':
