...
class EGNNSparse(MessagePassing):
    ...
    def __init__(
        ...
        #print('self.edge_input_dim:',self.edge_input_dim)
    ...
    def message(self, x_i, x_j, edge_attr) -> Tensor:
        ...
        #if(len(x_i)>0):
        #    print('len(x_i[0]):',len(x_i[0]))
        #print('len(edge_attr):',len(edge_attr))
        #print('len(edge_attr[0]):',len(edge_attr[0]))
